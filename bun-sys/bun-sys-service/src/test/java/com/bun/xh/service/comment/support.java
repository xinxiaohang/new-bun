...
public class support extends AbstractComment {
    ...
    public void test() throws BunServerException, BunServiceException {
        ...
        SupportCommentRequest supportCommentRequest = buildSupportCommentRequest(commentId);
        SupportCommentResponse supportCommentResponse = commentFacade.supportComment(supportCommentRequest);
        Assert.assertEquals(ResultCodeEnum.SUCCESS.getCode(),supportCommentResponse.getResultCode());
    }
}